      ...
      <nav className="topbar d-flex align-items-center justify-content-between">
        ...
        <div className="d-flex gap-2 align-items-center">
          ...
          <button
            ...
            onClick={() => { runPlot(); setShowPlot(true); }}
          >
            {isPlotting ? (
        ...
        <div className="row g-3">
          ...
          <div className="col-12 col-lg-4">
            ...
            <div className="card p-3">
              ...
              <div style={{ opacity: isRest ? 0.38 : 1, pointerEvents: isRest ? 'none' : 'auto', transition: 'opacity .2s' }}>
                <Chips
            ...
            <div className="card p-3 mb-3">
              <div className="d-flex align-items-center justify-content-between mb-2">
                <div className="d-flex align-items-center gap-2">
                  ...
                  <span style={{ fontSize: 11, color: 'var(--muted)', background: 'var(--border)', borderRadius: 4, padding: '1px 6px' }}>
              ...
              <div className="d-flex gap-3 align-items-start">
                <Silhouette selectedKeysByZone={selectedKeysByZone} onZoneClick={setModalZone} byZone={byZone} zoneRiskRows={zoneRiskRows} />
